...
#define MQTT_SKIP_PUBLISH_IF_DISCONNECTED 0


// #define MQTT_REPORT_DELETED_MESSAGES CONFIG_MQTT_REPORT_DELETED_MESSAGES
#define MQTT_REPORT_DELETED_MESSAGES 1
...
#define MQTT_NETWORK_TIMEOUT_MS     (2000)
...
#else
#define OUTBOX_EXPIRED_TIMEOUT_MS   (24*60*60*1000)
#endif
